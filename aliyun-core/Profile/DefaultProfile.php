<?php namespace Yeoman\AliyunCore\Profile;

use Yeoman\AliyunCore\Auth\Credential;
use Yeoman\AliyunCore\Auth\ShaHmac1Signer;
use Yeoman\AliyunCore\Regions\Endpoint;
use Yeoman\AliyunCore\Regions\ProductDomain;
